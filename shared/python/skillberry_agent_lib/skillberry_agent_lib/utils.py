...
def extract_base_url(url: str) -> Optional[str]:
    """
    Extract the base URL (scheme and hostname/IP) from a given URL string,
    excluding any port number or path.

    Args:
        url (str): The full URL string (e.g., 'https://example.com:8080/path').

    Returns:
        Optional[str]: The base URL containing only the scheme and hostname/IP
...
# print(extract_base_url("http://192.168.1.10:5000/test"))  # http://192.168.1.10
# print(extract_base_url("https://my-site.org"))            # https://my-site.org
