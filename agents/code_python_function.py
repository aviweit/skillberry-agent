...
base_python_coding_prompt_messages = [
    ...
    ("system", "The generated functions and tools should never output anything to the screen and to the console."),
    ("system", "The generated functions and tools will never output to stdout."),
    ("system", "The generated functions and tools always use python return value for the response."),
